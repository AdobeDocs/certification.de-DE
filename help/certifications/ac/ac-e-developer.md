...
>[!NOTE]
>
>**Neue verfügbare Studienressourcen:** Der [Leitfaden zur Prüfungsvorbereitung](https://app.rockinfo.com/courses/141) bietet einen maßgeschneiderten Pfad durch den Vorbereitungsprozess für die Zertifizierungsprüfung, einschließlich der Materialien, die Sie benötigen, um diese Zertifizierung erfolgreich zu erhalten. _Wenn Sie aufgefordert werden, sich beim Prüfungsvorbereitung anzumelden, verwenden Sie Ihren Adobe ID._
...
Sie sollten über mindestens 1-3 Jahre Erfahrung mit der Entwicklung von Adobe [!DNL Commerce] verfügen und mit den folgenden Technologien und Umgebungen vertraut sein:
...
* Demonstrieren Sie, wie Sie den Cache in Adobe [!DNL Commerce] effektiv verwenden
...
* Verwenden der Konfigurationsschicht in Adobe [!DNL Commerce]
* Arbeiten mit Routen in Adobe [!DNL Commerce]
...
* Identifizieren Sie die Adobe [!DNL Commerce]-Sicherheitsfunktion (CSP, Escaping, Formularschlüssel, Bereinigung, reCAPTCHA, Eingabevalidierung).
...
* Adobe [!DNL Commerce] Architektur-/Umgebungs-Workflow
* Arbeiten mit Cloud-Projektdateien, Berechtigungen und Strukturen demonstrieren
* Demonstration der Möglichkeit, domänenbasierte Stores mit mehreren Domänen auf der Adobe [!DNL Commerce] Cloud einzurichten (Multi-Domain-Sites-Mix aus Entwicklerarbeit und -unterstützung)
...
* Beschreiben Sie, wie Sie Adobe [!DNL Commerce] Cloud einrichten/konfigurieren
...
* Verstehen des Umgebungsmanagements mithilfe von CLI (CLI-Exklusivfunktionen: E-Mails aktivieren, Umgebungen neu starten, Snapshot, DB-Dump, lokale Umgebung einrichten)
* Verzweigungen mithilfe von CLI demonstrieren
* Veranschaulichen Sie die Fehlerbehebung bei Cloud-Services. (My SQL, Redis, tunnel:info)
...
[Prüfungsvorbereitung anzeigen](https://app.rockinfo.com/courses/141)
